...
import com.jn.filepickersphere.filelist.common.mime.isASpecificTypeOfMime
import com.jn.filepickersphere.filelist.common.mime.isMedia
...
object FileIcon {
    ...
    fun loadIcon(file: FileModel, binding: FileItemBinding, mimeType: String?, context: Context) {
        ...
        applyBackground(context, binding, mimeType?.isMimeTypeMedia() ?: false)
    }
    ...
    private fun applyBackground(context: Context, binding: FileItemBinding, isMedia: Boolean) {
        ...
        borderDrawable.setTint(borderTint)
